...
def train(demo_train, training, validation, model, globals):
    ...
    for epoch in range(training['epochs']):
        ...
        if os.path.exists("/content/how/how_temp/temp.pth"):
            tempname = "/content/how/how_temp/temp.pth"
        ...
        tempname = os.path.join("/content/how/how_temp","temp.pth")
