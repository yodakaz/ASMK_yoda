...
def load_dataset(dataset, data_root=''):
    ...
    if isinstance(dataset, dict):
        ...
        training_set = 'mitsubishi_dataset'
        db_root = os.path.join(data_root, 'train', training_set)
        ims_root = os.path.join(db_root, 'png_images')
        ...
        db_root = os.path.join(data_root, 'train', 'mitsubishi_dataset')
        fn_val_proper = db_root+'/mitsubishi_dataset_val-eccv2020.pkl' # pos are all with #inl >=3 & <= 10
